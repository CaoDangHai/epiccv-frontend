    ...
    <aside className="hidden md:flex flex-col py-6 px-4 space-y-2 h-[calc(100vh-64px)] w-64 border-r border-slate-200 bg-slate-50 sticky top-16 text-sm">
      <div className="flex-1 space-y-1">
        ...
        <div className="pt-4 px-2">
          <Button
            variant="unstyled"
            className="w-full py-3 px-4 bg-[var(--color-primary)] text-white font-semibold rounded-full shadow-lg hover:brightness-110 transition-all flex items-center justify-center gap-2"
          >

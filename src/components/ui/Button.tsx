...
export const Button: React.FC<ButtonProps> = ({
    ...
    if (variant !== 'unstyled') {
        baseClass += "inline-flex items-center justify-center gap-2 font-semibold transition-all active:scale-95 px-6 py-3 ";

        switch (rounded) {
            case 'full': baseClass += "rounded-full "; break;
            case 'xl': baseClass += "rounded-xl "; break;
            case 'lg': baseClass += "rounded-lg "; break;
            case 'md': baseClass += "rounded-md "; break;
            case 'none': baseClass += "rounded-none "; break;
        }
    }

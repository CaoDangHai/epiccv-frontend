        ...
        <div className="relative z-10 grid grid-cols-2 gap-6">
          <div className="bg-white/10 backdrop-blur-[24px] border border-white/10 p-8 rounded-2xl">
            ...
            <p className="text-white/60 text-sm leading-relaxed">
              Anticipate market trends and align your skills with future high-demand roles.
            </p>
          </div>
          <div className="bg-white/10 backdrop-blur-[24px] border border-white/10 p-8 rounded-2xl">
            <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center mb-6">
            ...
            <p className="text-white/60 text-sm leading-relaxed">
              Organized toolsets that adapt to your specific career path and project goals.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-md w-full mx-auto">
          <header className="mb-10">
            ...
            <p className="text-slate-500 font-medium">
              Join the elite network of career architects.
            </p>
          </header>

          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-2">
              <label className="block text-[11px] font-semibold tracking-widest uppercase text-slate-500 ml-1">
                Full Name
              </label>
            ...
            <div className="space-y-2">
              ...
              {errors.email && (
                <p className="text-red-500 text-xs ml-1 mt-1">{errors.email?.message as string}</p>
              )}
            </div>
            ...
            <Button
              ...
              type="submit"
              disabled={isLoading}
              className="w-full bg-blue-600 text-white font-bold py-4 rounded-full flex items-center justify-center gap-2 shadow-lg shadow-blue-500/30 hover:bg-blue-700 active:scale-[0.98] transition-all disabled:opacity-70 disabled:cursor-not-allowed"
            >
          ...
          <footer className="mt-12 text-center">
            ...
            <div className="flex flex-wrap justify-center items-center gap-6 w-full">
              ...
              <div className="flex gap-6">
                <a
                  className="text-[11px] font-semibold tracking-widest uppercase text-slate-400 hover:text-blue-600 transition-colors cursor-pointer"
                  href="#"
                >
                  Privacy Policy
                </a>
